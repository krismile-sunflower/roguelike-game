...
- 5 个递进地牢层级：旧井门厅、潮湿回廊、碎骨仓库、熄火祭室、深井王座，每层有不同压力、陷阱和补给结构。
- 实时格子移动与战斗：玩家可按住方向连续移动，Shift 可短冲刺；敌人会按自己的节奏持续追踪、游荡、近战或沿走廊施法。
- 敌人类型：黏液、蝙蝠、烛影侍从、游魂、赤甲守卫、深井看守。
- 掉落与成长：药水治疗、金币得分、余烬碎片共鸣、短剑提高攻击、盾牌提高最大生命；清层后从 3 个楼层祝福中选择 1 个。
- 地图互动：宝箱可打开并给金币、治疗或强化；治疗喷泉每层最多 1 个，使用后变暗；尖刺陷阱触发后失效。
- 战术 UI：右侧 HUD 显示威胁摘要、小地图、出口状态、宝箱/喷泉/陷阱计数和最近事件。
...
- Shift：向当前方向短冲刺，最多 2 格，不能穿墙或穿过敌人，路上的陷阱仍会触发。
- 撞向敌人：攻击。
- Space 或 `.`：停下脚步，方便重新观察。
- 烛影侍从：会沿同一行或列施法，墙体和其他敌人可以挡住视线。
- 余烬碎片：每收集 3 个触发一次小共鸣。
